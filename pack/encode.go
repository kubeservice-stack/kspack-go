...
func (e *encodeState) setKeyLen(k string) (l int) {
	if l = len(k); l > KSPACK_KEY_MAX_LEN {
		panic(fmt.Errorf("len(key) exceeds %d", KSPACK_KEY_MAX_LEN))
	}
